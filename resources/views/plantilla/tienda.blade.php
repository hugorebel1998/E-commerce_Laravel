...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('plant/plugins/font-awesome-4.7.0/css/font-awesome.min.css') }}">
        ...
        <div class="menu">
            ...
            <div class="menu_search">
                <form action="#" id="menu_search_form" class="menu_search_form">
                    ...
                    <button class="menu_search_button"><img src="{{ asset('plant/images/search.png') }}"
                            alt=""></button>
                </form>
            </div>
            <!-- Navigation -->
            ...
            <div class="menu_contact">
                <div class="menu_phone d-flex flex-row align-items-center justify-content-start">
                    <div>
                        <div><img src="{{ asset('plant/images/phone.svg') }}"
                    ...
                    <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                        ...
                        <div class="header_search">
                            <form action="#" id="header_search_form">
                                <input type="text" class="search_input" placeholder="Search Item" required="required">
                                <button class="header_search_button"><img src="{{ asset('plant/images/search.png') }}"
                                        alt=""></button>
                            </form>
                        </div>
                        ...
                        <div class="cart"><a href="cart.html">
                                <div><img class="svg" src="{{ asset('plant/images/cart.svg') }}"
            ...
            <div class="super_container_inner">
                        ...
                        <div class="owl-carousel owl-theme home_slider">
                            ...
                            <div class="owl-item">
                                <div class="background_image"
                                    style="background-image:url({{ asset('plant/images/home_2.jpg') }})"></div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="product home_item_large">
                                                                    ...
                                                                    <div class="product_image"><img
                                                                            src="{{ asset('plant/images/home_2.jpg') }}"
                                                                            alt=""></div>
                                                                        ...
                                                                        <div class="product_buttons">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div>
                                                                                        <div><img
                                                                                                src="{{ asset('plant/images/cart_2.svg') }}"
                                                                                                alt="">
                                                                                            <div>+</div>
                                                                                        </div>
                                                                                    </div>
                            ...
                            <div class="owl-item">
                                <div class="background_image"
                                    style="background-image:url({{ asset('plant/images/product_1.jpg') }})"></div>
                                <div class="container fill_height">
                                    <div class="row fill_height">
                                        <div class="col fill_height">
                                            <div
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="product home_item_large">
                                                                    ...
                                                                    <div class="product_image"><img
                                                                            src="{{ asset('plant/images/product_1.jpg') }}"
                                                                            alt=""></div>
                                                                    <div class="product_content">
                            ...
                            <div class="owl-item">
                                <div class="background_image"
                                    style="background-image:url({{ asset('plant/images/product_2.jpg') }})"></div>
                                <div class="container fill_height">
                                    <div class="row fill_height">
                                        <div class="col fill_height">
                                            <div
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="product home_item_large">
                                                                    ...
                                                                    <div class="product_image"><img
                                                                            src="{{ asset('plant/images/product_2.jpg') }}"
                                                                            alt=""></div>
                                                                    <div class="product_content">
                                                                        <div class="product_buttons">
                                                                            <div
                            ...
                            <div class="owl-item">
                                <div class="background_image"
                                    style="background-image:url({{ asset('plant/images/product_3.jpg') }})"></div>
                                <div class="container fill_height">
                                    <div class="row fill_height">
                                        <div class="col fill_height">
                                            <div
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="product home_item_large">
                                                                    ...
                                                                    <div class="product_image"><img
                                                                            src="{{ asset('plant/images/product_3.jpg') }}"
                                                                            alt=""></div>
                                                                    <div class="product_content">
                                                                        <div class="product_buttons">
                                                                            <div
                    ...
                    <div class="container">
                        ...
                        <div class="row products_row">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="product">
                                    <div class="product_image"><img src="{{ asset('plant/images/product_1.jpg') }}"
                                            alt=""></div>
                                    <div class="product_content">
                                        <div
                                        ...
                                        <div class="product_buttons">
                                            <div
                                                ...
                                                <div
                                                    class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
                                                    <div>
                                                        <div><img src="{{ asset('plant/images/cart.svg') }}" class="svg"
                                                                alt="">
                                                            <div>+</div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="product">
                                    <div class="product_image"><img src="{{ asset('plant/images/product_2.jpg') }}"
                                            alt=""></div>
                                    <div class="product_content">
                                        <div
                                            class="product_info d-flex flex-row align-items-start justify-content-start">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="product">
                                    <div class="product_image"><img src="{{ asset('plant/images/product_3.jpg') }}"
                                            alt=""></div>
                                    <div class="product_content">
                                        <div
                                            class="product_info d-flex flex-row align-items-start justify-content-start">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="product">
                                    <div class="product_image"><img src="{{ asset('plant/images/product_4.jpg') }}"
                                            alt=""></div>
                                    <div class="product_content">
                                        <div
                                            class="product_info d-flex flex-row align-items-start justify-content-start">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="product">
                                    <div class="product_image"><img src="{{ asset('plant/images/product_5.jpg') }}"
                                            alt=""></div>
                                    <div class="product_content">
                                        <div
                                            class="product_info d-flex flex-row align-items-start justify-content-start">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="product">
                                    <div class="product_image"><img src="{{ asset('plant/images/product_6.jpg') }}"
                                            alt=""></div>
                                    <div class="product_content">
                                        <div
                                            class="product_info d-flex flex-row align-items-start justify-content-start">
                ...
                <div class="lomasvendidocontenedor">
                    ...
                    <div class="lomasvendido owl-carousel owl-theme">
                        ...
                        <div class="">
                            <div class="product">
                                <div class="product_image"><img src="{{ asset('plant/images/product_5.jpg') }}" alt="">
                                </div>
                                <div class="product_content">
            ...
            <div class="lomasvendidocontenedor">
                ...
                <div class="lomasvendido owl-carousel owl-theme">
                                ...
                                <div class="product_buttons">
                                    <div class="text-right d-flex flex-row align-items-start justify-content-start">
                                        <div
                                            class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
                                            <div>
                                                <div><img src="{{ asset('plant/images/cart.svg') }}" class="svg" alt="">
                                                    <div>+</div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="item">
                        <div class="">
                            <div class="product">
                                <div class="product_image"><img src="{{ asset('plant/images/product_6.jpg') }}" alt="">
                                </div>
                                <div class="product_content">
                                    <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                        <div>
            ...
            <div class="row">
                <div class="col">
                    <div class="boxes_container d-flex flex-row align-items-start justify-content-between flex-wrap">
                        ...
                        <div class="box">
                            <div class="background_image"
                                style="background-image:url({{ asset('plant/images/box_1.jpg') }})"></div>
                            <div class="box_content d-flex flex-row align-items-center justify-content-start">
                                <div class="box_left">
                                    <div class="box_image">
                                        <a href="category.html">
                                            <div class="background_image"
                                                style="background-image:url({{ asset('plant/images/box_1_img.jpg') }})">
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="box">
                            <div class="background_image"
                                style="background-image:url({{ asset('plant/images/box_2.jpg') }})"></div>
                            <div class="box_content d-flex flex-row align-items-center justify-content-start">
                                <div class="box_left">
                                    <div class="box_image">
                                        <a href="category.html">
                                            <div class="background_image"
                                                style="background-image:url({{ asset('plant/images/box_2_img.jpg') }})">
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="box">
                            <div class="background_image"
                                style="background-image:url({{ asset('plant/images/box_3.jpg') }})"></div>
                            <div class="box_content d-flex flex-row align-items-center justify-content-start">
                                <div class="box_left">
                                    <div class="box_image">
                                        <a href="category.html">
                                            <div class="background_image"
                                                style="background-image:url({{ asset('plant/images/box_3_img.jpg') }})">
                                            </div>
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 feature_col">
                    <div class="feature d-flex flex-row align-items-start justify-content-start">
                        <div class="feature_left">
                            <div class="feature_icon ml-auto mr-auto"><img src="{{ asset('plant/images/icon_2.svg') }}"
                                    alt=""></div>
                        </div>
                        <div class="feature_right d-flex flex-column align-items-start justify-content-center">
                    ...
                    <div class="col-lg-4 footer_col">
                        <div class="footer_about">
                            <div class="footer_logo">
                                <a href="#">
                                    <div class="d-flex flex-row align-items-center justify-content-start">
                                        <div class="footer_logo_icon"><img src="{{ asset('plant/images/logo_2.png') }}"
                                                alt=""></div>
                                        <div>Jhonatan Shop</div>
                                    </div>
                                </a>
